	...
	try {
		...
		const platformInfo: Record<string, { message: string; url: string; instructions: string }> = {
			twitter: {
				...
				instructions:
					'The encoded message has been copied to your clipboard. Click "Open Twitter" to compose a new tweet, then paste and send!'
			},
			linkedin: {
				message: 'Ready to post to LinkedIn',
				url: 'https://www.linkedin.com/feed/',
				instructions:
					'The encoded message has been copied to your clipboard. Click "Open LinkedIn" to start a post, then paste and share!'
			},
			facebook: {
				message: 'Ready to post to Facebook',
				url: 'https://www.facebook.com/',
				instructions:
					'The encoded message has been copied to your clipboard. Click "Open Facebook" to create a post, then paste and publish!'
			},
			tiktok: {
				message: 'Ready to post to TikTok',
				url: 'https://www.tiktok.com/upload',
				instructions:
					'The encoded message has been copied to your clipboard. TikTok requires video content - use this as your caption when uploading a video!'
			}
		};
