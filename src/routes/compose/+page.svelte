...
<textarea class="textarea" rows="5" readonly data-clipboard="encoded" value={encodedMessage} />
</label>
...
<li>Copy the encoded message and paste it anywhere - it looks normal but contains your secret!</li>
