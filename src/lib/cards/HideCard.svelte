...
{#if hiddenType == 'image'}
	...
	<p class="text-sm opacity-75 mb-2">
		⚠️ Images will be automatically compressed to ~25KB and resized to fit under 40,000 character
		platform limits. Very large or complex images may take longer to compress.
	</p>
	<FileButton
